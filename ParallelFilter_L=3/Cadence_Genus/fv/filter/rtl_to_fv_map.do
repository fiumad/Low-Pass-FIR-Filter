...
# Generated on: Wed Mar 19 01:30:50 EDT 2025 (Wed Mar 19 05:30:50 UTC 2025)
...
set logfile fv/filter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/filter -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../filter.sv
elaborate_design -golden -root {filter} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/filter/fv_map.v.gz
elaborate_design -revised -root {filter}
...
set_analyze_option -mapping_file fv/filter/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.filter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.filter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.filter.rtl.fv_map.rpt
